    ...
    <div className="space-y-6">
      ...
      {selectedMenuItem && (
        <div className="fixed inset-0 z-50 flex items-start sm:items-center justify-center overflow-auto bg-black/40 p-4">
          <div className="w-full max-w-6xl rounded-[32px] bg-white shadow-2xl max-h-[90vh] overflow-hidden">
            ...
            <div className="space-y-6 overflow-y-auto p-6 max-h-[calc(90vh-5.5rem)]">
              {recipeError && (
      ...
      {editItem && (
        <div className="fixed inset-0 z-50 flex items-start sm:items-center justify-center overflow-auto bg-black/40 p-4">
          <div className="w-full max-w-3xl rounded-[32px] bg-white shadow-2xl max-h-[90vh] overflow-hidden">
            <div className="sticky top-0 z-20 flex flex-col gap-4 border-b border-slate-200 bg-white px-6 py-5 md:flex-row md:items-center md:justify-between">
              <div>
